...
| [:information_source:](# 'Publish the client-d3-charts npm package.')        | PR merge event (destination: trunk) | [![publish-client-d3-charts](https://github.com/rfprod/nx-ng-starter/actions/workflows/publish-client-d3-charts.yml/badge.svg)](https://github.com/rfprod/nx-ng-starter/actions/workflows/publish-client-d3-charts.yml)    |
| [:information_source:](# 'Publish the client-util-eliza npm package.')       | PR merge event (destination: trunk) | [![publish-client-util-eliza](https://github.com/rfprod/nx-ng-starter/actions/workflows/publish-client-util-eliza.yml/badge.svg)](https://github.com/rfprod/nx-ng-starter/actions/workflows/publish-client-util-eliza.yml) |
