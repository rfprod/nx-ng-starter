...
import { AppForceDirectedChartComponent } from './force-directed-chart.component';

describe('AppForceDirectedChartComponent', () => {
  const testBedConfig: TestModuleMetadata = {
    imports: [NoopAnimationsModule, BrowserDynamicTestingModule],
    declarations: [AppForceDirectedChartComponent],
    providers: [
      {
        provide: DOCUMENT,
        useValue: document,
  ...
  test.todo('AppForceDirectedChartComponent');
});
