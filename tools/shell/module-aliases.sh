...
MODULE_ALIAS_LIB_SHARED_STORE="lib:shared-store"
MODULE_ALIAS_LIB_SHARED_UTIL="lib:shared-util"
MODULE_ALIAS_LIB_SHARED_UI="lib:shared-ui"
MODULE_ALIAS_LIB_SHARED_UI_MATERIAL="lib:shared-ui-material"
MODULE_ALIAS_LIB_SHARED_UI_TRANSLATE="lib:shared-ui-translate"
MODULE_ALIAS_LIB_SHARED_SERVICES="lib:shared-services"
...
MODULE_ALIAS_NAMES=(
  ...
  MODULE_ALIAS_LIB_SHARED_STORE
  MODULE_ALIAS_LIB_SHARED_UTIL
  MODULE_ALIAS_LIB_SHARED_UI
  MODULE_ALIAS_LIB_SHARED_UI_MATERIAL
  MODULE_ALIAS_LIB_SHARED_UI_TRANSLATE
  MODULE_ALIAS_LIB_SHARED_SERVICES
