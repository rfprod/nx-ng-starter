...
MODULE_ALIAS_LIB_CLIENT_UI="lib:client-ui"
MODULE_ALIAS_LIB_CLIENT_UI_MATERIAL="lib:client-ui-material"
MODULE_ALIAS_LIB_CLIENT_UI_TRANSLATE="lib:client-ui-translate"
...
MODULE_ALIAS_NAMES=(
  ...
  MODULE_ALIAS_LIB_CLIENT_UI
  MODULE_ALIAS_LIB_CLIENT_UI_MATERIAL
  MODULE_ALIAS_LIB_CLIENT_UI_TRANSLATE
